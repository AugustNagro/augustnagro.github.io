...
function $p_LSodokuSolver$package$__rowIsInvalid$1__I__I__AALSquareState__I__I__Z($thiz, row$3, col$3, board$1, x$1, r) {
  var r$tailLocal1 = r;
  while (true) {
    if ((($m_LSodokuSolver$package$().toNum__LSquareState__I(board$1.get(r$tailLocal1).get(col$3)) === x$1) && (r$tailLocal1 !== row$3))) {
      return true
    } else if ((r$tailLocal1 === 9)) {
      return false
    } else {
      r$tailLocal1 = ((1 + r$tailLocal1) | 0)
    }
  }
}
/** @constructor */
function $c_LSodokuSolver$package$() {
  this.LSodokuSolver$package$__f_Inputs = null;
  this.LSodokuSolver$package$__f_State = null;
  $n_LSodokuSolver$package$ = this;
  var array = new ($d_sjs_js_Dynamic.getArrayOf().getArrayOf().constr)(9);
  var i = 0;
  while ((i < 9)) {
    var $$x2 = i;
    var array$1 = new ($d_sjs_js_Dynamic.getArrayOf().constr)(9);
    var i$1 = 0;
    while ((i$1 < 9)) {
      var $$x1 = i$1;
      var i$2 = document.createElement("input");
      i$2.type = "text";
      i$2.size = "1";
      i$2.style = "font-weight: bold";
      array$1.set($$x1, i$2);
      i$1 = ((1 + i$1) | 0)
    };
    array.set($$x2, array$1);
    i = ((1 + i) | 0)
  };
  this.LSodokuSolver$package$__f_Inputs = array;
  var array$2 = new ($d_LSquareState.getArrayOf().getArrayOf().constr)(9);
  var i$3 = 0;
  while ((i$3 < 9)) {
    var $$x3 = i$3;
    var array$3 = new ($d_LSquareState.getArrayOf().constr)(9);
    var i$4 = 0;
    while ((i$4 < 9)) {
      array$3.set(i$4, $s_LSquareState$__Empty__LSquareState());
      i$4 = ((1 + i$4) | 0)
    };
    array$2.set($$x3, array$3);
    i$3 = ((1 + i$3) | 0)
  };
  this.LSodokuSolver$package$__f_State = array$2
}
$c_LSodokuSolver$package$.prototype = new $h_O();
$c_LSodokuSolver$package$.prototype.constructor = $c_LSodokuSolver$package$;
/** @constructor */
function $h_LSodokuSolver$package$() {
  /*<skip>*/
}
$h_LSodokuSolver$package$.prototype = $c_LSodokuSolver$package$.prototype;
$c_LSodokuSolver$package$.prototype.loadTestData__V = (function() {
  var arr = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$1 = $asArrayOf_O(arr.get(0), 1);
  arr$1.get(0).value = "2";
  var arr$2 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$3 = $asArrayOf_O(arr$2.get(0), 1);
  arr$3.get(2).value = "4";
  var arr$4 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$5 = $asArrayOf_O(arr$4.get(0), 1);
  arr$5.get(4).value = "7";
  var arr$6 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$7 = $asArrayOf_O(arr$6.get(0), 1);
  arr$7.get(5).value = "9";
  var arr$8 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$9 = $asArrayOf_O(arr$8.get(0), 1);
  arr$9.get(6).value = "5";
  var arr$10 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$11 = $asArrayOf_O(arr$10.get(1), 1);
  arr$11.get(4).value = "5";
  var arr$12 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$13 = $asArrayOf_O(arr$12.get(1), 1);
  arr$13.get(8).value = "6";
  var arr$14 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$15 = $asArrayOf_O(arr$14.get(2), 1);
  arr$15.get(1).value = "6";
  var arr$16 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$17 = $asArrayOf_O(arr$16.get(2), 1);
  arr$17.get(4).value = "2";
  var arr$18 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$19 = $asArrayOf_O(arr$18.get(2), 1);
  arr$19.get(5).value = "3";
  var arr$20 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$21 = $asArrayOf_O(arr$20.get(2), 1);
  arr$21.get(6).value = "1";
  var arr$22 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$23 = $asArrayOf_O(arr$22.get(3), 1);
  arr$23.get(2).value = "3";
  var arr$24 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$25 = $asArrayOf_O(arr$24.get(3), 1);
  arr$25.get(7).value = "4";
  var arr$26 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$27 = $asArrayOf_O(arr$26.get(4), 1);
  arr$27.get(0).value = "6";
  var arr$28 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$29 = $asArrayOf_O(arr$28.get(4), 1);
  arr$29.get(2).value = "5";
  var arr$30 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$31 = $asArrayOf_O(arr$30.get(4), 1);
  arr$31.get(6).value = "9";
  var arr$32 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$33 = $asArrayOf_O(arr$32.get(4), 1);
  arr$33.get(8).value = "1";
  var arr$34 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$35 = $asArrayOf_O(arr$34.get(5), 1);
  arr$35.get(1).value = "2";
  var arr$36 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$37 = $asArrayOf_O(arr$36.get(5), 1);
  arr$37.get(6).value = "3";
  var arr$38 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$39 = $asArrayOf_O(arr$38.get(6), 1);
  arr$39.get(2).value = "6";
  var arr$40 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$41 = $asArrayOf_O(arr$40.get(6), 1);
  arr$41.get(3).value = "5";
  var arr$42 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$43 = $asArrayOf_O(arr$42.get(6), 1);
  arr$43.get(4).value = "9";
  var arr$44 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$45 = $asArrayOf_O(arr$44.get(6), 1);
  arr$45.get(7).value = "1";
  var arr$46 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$47 = $asArrayOf_O(arr$46.get(7), 1);
  arr$47.get(0).value = "1";
  var arr$48 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$49 = $asArrayOf_O(arr$48.get(7), 1);
  arr$49.get(4).value = "4";
  var arr$50 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$51 = $asArrayOf_O(arr$50.get(8), 1);
  arr$51.get(2).value = "8";
  var arr$52 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$53 = $asArrayOf_O(arr$52.get(8), 1);
  arr$53.get(3).value = "3";
  var arr$54 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$55 = $asArrayOf_O(arr$54.get(8), 1);
  arr$55.get(4).value = "1";
  var arr$56 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$57 = $asArrayOf_O(arr$56.get(8), 1);
  arr$57.get(6).value = "2";
  var arr$58 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var arr$59 = $asArrayOf_O(arr$58.get(8), 1);
  arr$59.get(8).value = "7"
});
$c_LSodokuSolver$package$.prototype.app__Lorg_getshaka_shaka_Element__Lorg_getshaka_shaka_Binding__V = (function(evidence$1, evidence$2) {
  var e = document.createElement("div");
  var e$1 = document.createElement("div");
  e$1.id = "board";
  var arr = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var f$1 = ((this$4, divEl$2) => ((row) => {
    var row$1 = $asArrayOf_sjs_js_Dynamic(row, 1);
    var f = ((this$5, divEl$1$2) => ((i) => divEl$1$2.appendChild(i)))(this$4, divEl$2);
    var len = row$1.u.length;
    var i$1 = 0;
    if ((row$1 !== null)) {
      while ((i$1 < len)) {
        var arg1 = row$1.get(i$1);
        f(arg1);
        i$1 = ((1 + i$1) | 0)
      }
    } else if ((row$1 instanceof $ac_I)) {
      var x3 = $asArrayOf_I(row$1, 1);
      while ((i$1 < len)) {
        var arg1$1 = x3.get(i$1);
        f(arg1$1);
        i$1 = ((1 + i$1) | 0)
      }
  ...
  var len$1 = arr.u.length;
  var i$2 = 0;
  if ((arr !== null)) {
    while ((i$2 < len$1)) {
      var arg1$8 = arr.get(i$2);
      f$1(arg1$8);
      i$2 = ((1 + i$2) | 0)
    }
  } else if ((arr instanceof $ac_I)) {
    var x3$1 = $asArrayOf_I(arr, 1);
    while ((i$2 < len$1)) {
      var arg1$9 = x3$1.get(i$2);
      f$1(arg1$9);
      i$2 = ((1 + i$2) | 0)
    }
  } else if ((arr instanceof $ac_D)) {
    var x4$1 = $asArrayOf_D(arr, 1);
    while ((i$2 < len$1)) {
  ...
  e.appendChild(e$1);
  var e$2 = document.createElement("button");
  e$2.appendChild(document.createTextNode("Click to solve"));
  var value$proxy1 = new $c_sjsr_AnonFunction0(((this$14) => (() => {
    $m_LSodokuSolver$package$().solve__V()
  }))(this));
  new $c_Lorg_getshaka_nativeconverter_NativeConverter$fConv();
  e$2.onclick = $m_sjs_js_Any$().fromFunction0__F0__sjs_js_Function0(value$proxy1);
  e.appendChild(e$2);
  var e$3 = document.createElement("button");
  e$3.appendChild(document.createTextNode("Clear"));
  var value$proxy2 = new $c_sjsr_AnonFunction0(((this$18) => (() => {
    $m_LSodokuSolver$package$().clearBoard__V()
  }))(this));
  new $c_Lorg_getshaka_nativeconverter_NativeConverter$fConv();
  e$3.onclick = $m_sjs_js_Any$().fromFunction0__F0__sjs_js_Function0(value$proxy2);
  e.appendChild(e$3);
  evidence$1.appendChild(e)
});
$c_LSodokuSolver$package$.prototype.solve__V = (function() {
  var i = 0;
  while ((i < 9)) {
    var i$2 = 0;
    while ((i$2 < 9)) {
      var arr = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
      var n = i;
      var arr$1 = $asArrayOf_O(arr.get(n), 1);
      var n$1 = i$2;
      var input = arr$1.get(n$1);
      var inputValue = $as_T(input.value);
      input.setAttribute("readonly", "true");
      if (((inputValue === null) || (inputValue === ""))) {
        input.style = "";
        $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(i).set(i$2, $s_LSquareState$__Empty__LSquareState())
      } else {
        var $$x2 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(i);
        var $$x1 = i$2;
        var this$8 = $m_jl_Integer$();
        var i$1 = this$8.parseInt__T__I__I(inputValue, 10);
        $$x2.set($$x1, new $c_LSquareState$SetByUser(i$1))
      };
      var _$1 = i$2;
      i$2 = ((1 + _$1) | 0)
    };
  ...
  while (true) {
    ...
    if (((elem !== 9) && ($m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(elem).get(elem$1) instanceof $c_LSquareState$SetByUser))) {
      continue
    };
    break
  };
  while ((elem !== 9)) {
    var square = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(elem).get(elem$1);
    var squareNum = $m_LSodokuSolver$package$().toNum__LSquareState__I(square);
    if ((squareNum < 9)) {
      squareNum = ((1 + squareNum) | 0);
      var $$x4 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(elem);
      var $$x3 = elem$1;
      var i$3 = squareNum;
      $$x4.set($$x3, new $c_LSquareState$Set(i$3));
      if ($m_LSodokuSolver$package$().moveIsValid__I__I__AALSquareState__Z(elem, elem$1, $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State)) {
        while (true) {
          if ((elem$1 === 8)) {
            var ev$1$1 = ((1 + elem) | 0);
            elem = ev$1$1;
      ...
      $m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(elem).set(elem$1, $s_LSquareState$__Empty__LSquareState());
      while (true) {
        if ((elem$1 === 0)) {
          var ev$4 = (((-1) + elem) | 0);
          elem = ev$4;
        ...
        if (($m_LSodokuSolver$package$().LSodokuSolver$package$__f_State.get(elem).get(elem$1) instanceof $c_LSquareState$SetByUser)) {
          continue
        };
        break
      }
  ...
  this$15.java$lang$JSConsoleBasedPrintStream$$printString__T__V("solved\n");
  var arr$2 = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var f$1 = ((this$16) => ((row$2) => {
    var row = $asArrayOf_sjs_js_Dynamic(row$2, 1);
    var f = ((this$17) => ((i$4) => i$4.removeAttribute("readonly")))(this$16);
    var len = row.u.length;
    var i$5 = 0;
    if ((row !== null)) {
      while ((i$5 < len)) {
        var arg1 = row.get(i$5);
        f(arg1);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_I)) {
      var x3 = $asArrayOf_I(row, 1);
      while ((i$5 < len)) {
        var arg1$1 = x3.get(i$5);
        f(arg1$1);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_D)) {
      var x4 = $asArrayOf_D(row, 1);
      while ((i$5 < len)) {
        var arg1$2 = x4.get(i$5);
        f(arg1$2);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_J)) {
      var x5 = $asArrayOf_J(row, 1);
      while ((i$5 < len)) {
        var t = x5.get(i$5);
        var lo = t.RTLong__f_lo;
        var hi = t.RTLong__f_hi;
    ...
    } else if ((row instanceof $ac_F)) {
      var x6 = $asArrayOf_F(row, 1);
      while ((i$5 < len)) {
        var arg1$3 = x6.get(i$5);
        f(arg1$3);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_C)) {
      var x7 = $asArrayOf_C(row, 1);
      while ((i$5 < len)) {
        var arg1$4 = x7.get(i$5);
        f($bC(arg1$4));
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_B)) {
      var x8 = $asArrayOf_B(row, 1);
      while ((i$5 < len)) {
        var arg1$5 = x8.get(i$5);
        f(arg1$5);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_S)) {
      var x9 = $asArrayOf_S(row, 1);
      while ((i$5 < len)) {
        var arg1$6 = x9.get(i$5);
        f(arg1$6);
        i$5 = ((1 + i$5) | 0)
      }
    } else if ((row instanceof $ac_Z)) {
      var x10 = $asArrayOf_Z(row, 1);
      while ((i$5 < len)) {
        var arg1$7 = x10.get(i$5);
        f(arg1$7);
        i$5 = ((1 + i$5) | 0)
      }
    } else {
      throw new $c_s_MatchError(row)
    }
  }))(this);
  var len$1 = arr$2.u.length;
  var i$6 = 0;
  if ((arr$2 !== null)) {
    while ((i$6 < len$1)) {
      var arg1$8 = arr$2.get(i$6);
      f$1(arg1$8);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_I)) {
    var x3$1 = $asArrayOf_I(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$9 = x3$1.get(i$6);
      f$1(arg1$9);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_D)) {
    var x4$1 = $asArrayOf_D(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$10 = x4$1.get(i$6);
      f$1(arg1$10);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_J)) {
    var x5$1 = $asArrayOf_J(arr$2, 1);
    while ((i$6 < len$1)) {
      var t$1 = x5$1.get(i$6);
      var lo$1 = t$1.RTLong__f_lo;
      var hi$1 = t$1.RTLong__f_hi;
      f$1(new $c_RTLong(lo$1, hi$1));
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_F)) {
    var x6$1 = $asArrayOf_F(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$11 = x6$1.get(i$6);
      f$1(arg1$11);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_C)) {
    var x7$1 = $asArrayOf_C(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$12 = x7$1.get(i$6);
      f$1($bC(arg1$12));
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_B)) {
    var x8$1 = $asArrayOf_B(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$13 = x8$1.get(i$6);
      f$1(arg1$13);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_S)) {
    var x9$1 = $asArrayOf_S(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$14 = x9$1.get(i$6);
      f$1(arg1$14);
      i$6 = ((1 + i$6) | 0)
    }
  } else if ((arr$2 instanceof $ac_Z)) {
    var x10$1 = $asArrayOf_Z(arr$2, 1);
    while ((i$6 < len$1)) {
      var arg1$15 = x10$1.get(i$6);
      f$1(arg1$15);
      i$6 = ((1 + i$6) | 0)
    }
  } else {
    throw new $c_s_MatchError(arr$2)
  }
});
$c_LSodokuSolver$package$.prototype.toNum__LSquareState__I = (function(s) {
  var x = $s_LSquareState$__Empty__LSquareState();
  if (((x === null) ? (s === null) : x.equals__O__Z(s))) {
    return 0
  };
  if ((s instanceof $c_LSquareState$SetByUser)) {
    var x$1 = $as_LSquareState$SetByUser(s);
    var x16 = x$1.LSquareState$SetByUser__f_i;
    return x16
  };
  if ((s instanceof $c_LSquareState$Set)) {
    var x$1$1 = $as_LSquareState$Set(s);
    var x13 = x$1$1.LSquareState$Set__f_i;
    return x13
  };
  throw new $c_s_MatchError(s)
});
$c_LSodokuSolver$package$.prototype.moveIsValid__I__I__AALSquareState__Z = (function(row, col, board) {
  var nonLocalReturnKey1 = $ct_O__(new $c_O());
  try {
    var x = $m_LSodokuSolver$package$().toNum__LSquareState__I(board.get(row).get(col));
    if ($p_LSodokuSolver$package$__rowIsInvalid$1__I__I__AALSquareState__I__I__Z(this, row, col, board, x, 0)) {
      return false
    };
    var i = 0;
    while ((i < 9)) {
      if ((($m_LSodokuSolver$package$().toNum__LSquareState__I(board.get(i).get(col)) === x) && (i !== row))) {
        return false
      };
      var _$1 = i;
      i = ((1 + _$1) | 0)
    ...
    while (true) {
      var arg1 = i$1;
      if ((($m_LSodokuSolver$package$().toNum__LSquareState__I(board.get(arg1).get(col)) === x) && (arg1 !== row))) {
        throw new $c_sr_NonLocalReturnControl(nonLocalReturnKey1, false)
      };
      if ((i$1 === 8)) {
        break
      };
    ...
    var i$2 = 0;
    while ((i$2 < 9)) {
      if ((($m_LSodokuSolver$package$().toNum__LSquareState__I(board.get(row).get(i$2)) === x) && (i$2 !== col))) {
        return false
      };
      var _$1$2 = i$2;
      i$2 = ((1 + _$1$2) | 0)
    };
    var rowGroup = $imul(3, ((row / 3) | 0));
    var colGroup = $imul(3, ((col / 3) | 0));
    var i$3 = 0;
    while ((i$3 < 3)) {
      var i$4 = 0;
      while ((i$4 < 3)) {
        var r1 = ((rowGroup + i$3) | 0);
        var c1 = ((colGroup + i$4) | 0);
        if ((($m_LSodokuSolver$package$().toNum__LSquareState__I(board.get(r1).get(c1)) === x) && ((r1 !== row) || (c1 !== col)))) {
          return false
        };
        var _$1$3 = i$4;
        i$4 = ((1 + _$1$3) | 0)
    ...
    if ((e instanceof $c_sr_NonLocalReturnControl)) {
      ...
      if ((ex.sr_NonLocalReturnControl__f_key === nonLocalReturnKey1)) {
        return $uZ(ex.sr_NonLocalReturnControl__f_value)
      } else {
        throw ex
      }
    } else {
...
$c_LSodokuSolver$package$.prototype.clearBoard__V = (function() {
  var arr = $m_LSodokuSolver$package$().LSodokuSolver$package$__f_Inputs;
  var f$1 = ((this$1) => ((row) => {
    var row$1 = $asArrayOf_sjs_js_Dynamic(row, 1);
    var f = ((this$2) => ((i) => {
...
$c_LSodokuSolver$package$.prototype.launchApp__V = (function() {
  var element = $m_Lorg_getshaka_shaka_Helpers$package$().renderBuilder$default$2__Lorg_getshaka_shaka_Element();
  var arg2 = new $c_Lorg_getshaka_shaka_RootBinding();
  $m_LSodokuSolver$package$().app__Lorg_getshaka_shaka_Element__Lorg_getshaka_shaka_Binding__V(element, arg2);
  $m_LSodokuSolver$package$().loadTestData__V()
});
var $d_LSodokuSolver$package$ = new $TypeData().initClass({
  LSodokuSolver$package$: 0
}, false, "SodokuSolver$package$", {
  LSodokuSolver$package$: 1,
  O: 1
});
$c_LSodokuSolver$package$.prototype.$classData = $d_LSodokuSolver$package$;
var $n_LSodokuSolver$package$;
function $m_LSodokuSolver$package$() {
  if ((!$n_LSodokuSolver$package$)) {
    $n_LSodokuSolver$package$ = new $c_LSodokuSolver$package$()
  };
  return $n_LSodokuSolver$package$
}
/** @constructor */
...
function $s_LlaunchApp__main__AT__V(args) {
  try {
    $m_LSodokuSolver$package$().launchApp__V()
  } catch (e) {
    if (false) {
...
/** @constructor */
function $c_Lorg_getshaka_shaka_Helpers$package$() {
  /*<skip>*/
}
$c_Lorg_getshaka_shaka_Helpers$package$.prototype = new $h_O();
$c_Lorg_getshaka_shaka_Helpers$package$.prototype.constructor = $c_Lorg_getshaka_shaka_Helpers$package$;
/** @constructor */
function $h_Lorg_getshaka_shaka_Helpers$package$() {
  /*<skip>*/
}
$h_Lorg_getshaka_shaka_Helpers$package$.prototype = $c_Lorg_getshaka_shaka_Helpers$package$.prototype;
$c_Lorg_getshaka_shaka_Helpers$package$.prototype.renderBuilder$default$2__Lorg_getshaka_shaka_Element = (function() {
  return document.body
});
var $d_Lorg_getshaka_shaka_Helpers$package$ = new $TypeData().initClass({
  Lorg_getshaka_shaka_Helpers$package$: 0
}, false, "org.getshaka.shaka.Helpers$package$", {
  Lorg_getshaka_shaka_Helpers$package$: 1,
  O: 1
});
$c_Lorg_getshaka_shaka_Helpers$package$.prototype.$classData = $d_Lorg_getshaka_shaka_Helpers$package$;
var $n_Lorg_getshaka_shaka_Helpers$package$;
function $m_Lorg_getshaka_shaka_Helpers$package$() {
  if ((!$n_Lorg_getshaka_shaka_Helpers$package$)) {
    $n_Lorg_getshaka_shaka_Helpers$package$ = new $c_Lorg_getshaka_shaka_Helpers$package$()
  };
  return $n_Lorg_getshaka_shaka_Helpers$package$
}
...
/** @constructor */
function $c_Lorg_getshaka_nativeconverter_NativeConverter$fConv() {
  /*<skip>*/
}
$c_Lorg_getshaka_nativeconverter_NativeConverter$fConv.prototype = new $h_O();
$c_Lorg_getshaka_nativeconverter_NativeConverter$fConv.prototype.constructor = $c_Lorg_getshaka_nativeconverter_NativeConverter$fConv;
/** @constructor */
function $h_Lorg_getshaka_nativeconverter_NativeConverter$fConv() {
  /*<skip>*/
}
$h_Lorg_getshaka_nativeconverter_NativeConverter$fConv.prototype = $c_Lorg_getshaka_nativeconverter_NativeConverter$fConv.prototype;
var $d_Lorg_getshaka_nativeconverter_NativeConverter$fConv = new $TypeData().initClass({
  Lorg_getshaka_nativeconverter_NativeConverter$fConv: 0
}, false, "org.getshaka.nativeconverter.NativeConverter$fConv", {
  Lorg_getshaka_nativeconverter_NativeConverter$fConv: 1,
  O: 1,
  Lorg_getshaka_nativeconverter_NativeConverter: 1
});
$c_Lorg_getshaka_nativeconverter_NativeConverter$fConv.prototype.$classData = $d_Lorg_getshaka_nativeconverter_NativeConverter$fConv;
/** @constructor */
function $c_Lorg_getshaka_shaka_RootBinding() {
  /*<skip>*/
}
$c_Lorg_getshaka_shaka_RootBinding.prototype = new $h_O();
$c_Lorg_getshaka_shaka_RootBinding.prototype.constructor = $c_Lorg_getshaka_shaka_RootBinding;
/** @constructor */
function $h_Lorg_getshaka_shaka_RootBinding() {
  /*<skip>*/
}
$h_Lorg_getshaka_shaka_RootBinding.prototype = $c_Lorg_getshaka_shaka_RootBinding.prototype;
var $d_Lorg_getshaka_shaka_RootBinding = new $TypeData().initClass({
  Lorg_getshaka_shaka_RootBinding: 0
}, false, "org.getshaka.shaka.RootBinding", {
  Lorg_getshaka_shaka_RootBinding: 1,
  O: 1,
  Lorg_getshaka_shaka_Binding: 1
});
$c_Lorg_getshaka_shaka_RootBinding.prototype.$classData = $d_Lorg_getshaka_shaka_RootBinding;
...
function $isArrayOf_sjs_js_Dynamic(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_Dynamic)))
}
function $asArrayOf_sjs_js_Dynamic(obj, depth) {
  return (($isArrayOf_sjs_js_Dynamic(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscala.scalajs.js.Dynamic;", depth))
}
...
function $s_LSquareState$__Empty__LSquareState() {
  $m_LSquareState$();
  return $t_LSquareState$__Empty
}
/** @constructor */
function $c_LSquareState$() {
  $n_LSquareState$ = this;
  $t_LSquareState$__Empty = new $c_LSquareState$$anon$1(1, "Empty")
}
$c_LSquareState$.prototype = new $h_O();
$c_LSquareState$.prototype.constructor = $c_LSquareState$;
/** @constructor */
function $h_LSquareState$() {
  /*<skip>*/
}
$h_LSquareState$.prototype = $c_LSquareState$.prototype;
var $d_LSquareState$ = new $TypeData().initClass({
  LSquareState$: 0
}, false, "SquareState$", {
  LSquareState$: 1,
  O: 1,
...
$c_LSquareState$.prototype.$classData = $d_LSquareState$;
var $n_LSquareState$;
function $m_LSquareState$() {
  if ((!$n_LSquareState$)) {
    $n_LSquareState$ = new $c_LSquareState$()
  };
  return $n_LSquareState$
}
...
$h_LSquareState.prototype = $c_LSquareState.prototype;
$c_LSquareState.prototype.productIterator__sc_Iterator = (function() {
...
/** @constructor */
function $c_LSquareState$Set(i) {
  this.LSquareState$Set__f_i = 0;
  this.LSquareState$Set__f_i = i
}
$c_LSquareState$Set.prototype = new $h_LSquareState();
$c_LSquareState$Set.prototype.constructor = $c_LSquareState$Set;
/** @constructor */
function $h_LSquareState$Set() {
  /*<skip>*/
}
$h_LSquareState$Set.prototype = $c_LSquareState$Set.prototype;
$c_LSquareState$Set.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Set");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var data$1 = this.LSquareState$Set__f_i;
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  return $m_sr_Statics$().finalizeHash__I__I__I(hash$2, 1)
});
$c_LSquareState$Set.prototype.equals__O__Z = (function(x$0) {
  if ((this === x$0)) {
    return true
  } else if ((x$0 instanceof $c_LSquareState$Set)) {
    var x$0$2 = $as_LSquareState$Set(x$0);
    return (this.LSquareState$Set__f_i === x$0$2.LSquareState$Set__f_i)
  } else {
    return false
  }
});
$c_LSquareState$Set.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_LSquareState$Set.prototype.productArity__I = (function() {
  return 1
});
$c_LSquareState$Set.prototype.productPrefix__T = (function() {
  return "Set"
});
$c_LSquareState$Set.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.LSquareState$Set__f_i
  };
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
});
function $as_LSquareState$Set(obj) {
  return (((obj instanceof $c_LSquareState$Set) || (obj === null)) ? obj : $throwClassCastException(obj, "SquareState$Set"))
}
function $isArrayOf_LSquareState$Set(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LSquareState$Set)))
}
function $asArrayOf_LSquareState$Set(obj, depth) {
  return (($isArrayOf_LSquareState$Set(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LSquareState$Set;", depth))
}
var $d_LSquareState$Set = new $TypeData().initClass({
  LSquareState$Set: 0
}, false, "SquareState$Set", {
  LSquareState$Set: 1,
  LSquareState: 1,
  O: 1,
  s_Equals: 1,
...
$c_LSquareState$Set.prototype.$classData = $d_LSquareState$Set;
/** @constructor */
function $c_LSquareState$SetByUser(i) {
  this.LSquareState$SetByUser__f_i = 0;
  this.LSquareState$SetByUser__f_i = i
}
$c_LSquareState$SetByUser.prototype = new $h_LSquareState();
$c_LSquareState$SetByUser.prototype.constructor = $c_LSquareState$SetByUser;
/** @constructor */
function $h_LSquareState$SetByUser() {
  /*<skip>*/
}
$h_LSquareState$SetByUser.prototype = $c_LSquareState$SetByUser.prototype;
$c_LSquareState$SetByUser.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("SetByUser");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var data$1 = this.LSquareState$SetByUser__f_i;
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  return $m_sr_Statics$().finalizeHash__I__I__I(hash$2, 1)
});
$c_LSquareState$SetByUser.prototype.equals__O__Z = (function(x$0) {
  if ((this === x$0)) {
    return true
  } else if ((x$0 instanceof $c_LSquareState$SetByUser)) {
    var x$0$2 = $as_LSquareState$SetByUser(x$0);
    return (this.LSquareState$SetByUser__f_i === x$0$2.LSquareState$SetByUser__f_i)
  } else {
    return false
  }
});
$c_LSquareState$SetByUser.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_LSquareState$SetByUser.prototype.productArity__I = (function() {
  return 1
});
$c_LSquareState$SetByUser.prototype.productPrefix__T = (function() {
  return "SetByUser"
});
$c_LSquareState$SetByUser.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.LSquareState$SetByUser__f_i
  };
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
});
function $as_LSquareState$SetByUser(obj) {
  return (((obj instanceof $c_LSquareState$SetByUser) || (obj === null)) ? obj : $throwClassCastException(obj, "SquareState$SetByUser"))
}
function $isArrayOf_LSquareState$SetByUser(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LSquareState$SetByUser)))
}
function $asArrayOf_LSquareState$SetByUser(obj, depth) {
  return (($isArrayOf_LSquareState$SetByUser(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LSquareState$SetByUser;", depth))
}
var $d_LSquareState$SetByUser = new $TypeData().initClass({
  LSquareState$SetByUser: 0
}, false, "SquareState$SetByUser", {
  LSquareState$SetByUser: 1,
  LSquareState: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
...
$c_LSquareState$SetByUser.prototype.$classData = $d_LSquareState$SetByUser;
...
/** @constructor */
function $c_LSquareState$$anon$1(_$ordinal$2, \u03b4name$2) {
  this.LSquareState$$anon$1__f__$ordinal$1 = 0;
  this.LSquareState$$anon$1__f_$name$1 = null;
  this.LSquareState$$anon$1__f__$ordinal$1 = _$ordinal$2;
  this.LSquareState$$anon$1__f_$name$1 = \u03b4name$2
}
$c_LSquareState$$anon$1.prototype = new $h_LSquareState();
$c_LSquareState$$anon$1.prototype.constructor = $c_LSquareState$$anon$1;
/** @constructor */
function $h_LSquareState$$anon$1() {
  /*<skip>*/
}
$h_LSquareState$$anon$1.prototype = $c_LSquareState$$anon$1.prototype;
$c_LSquareState$$anon$1.prototype.productArity__I = (function() {
  return 0
});
$c_LSquareState$$anon$1.prototype.productElement__I__O = (function(n) {
  return $f_sr_EnumValue__productElement__I__O(this, n)
});
$c_LSquareState$$anon$1.prototype.productPrefix__T = (function() {
  return this.LSquareState$$anon$1__f_$name$1
});
$c_LSquareState$$anon$1.prototype.toString__T = (function() {
  return this.LSquareState$$anon$1__f_$name$1
});
var $d_LSquareState$$anon$1 = new $TypeData().initClass({
  LSquareState$$anon$1: 0
}, false, "SquareState$$anon$1", {
  LSquareState$$anon$1: 1,
  LSquareState: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
...
$c_LSquareState$$anon$1.prototype.$classData = $d_LSquareState$$anon$1;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
var $t_LSquareState$__Empty = null;
$s_LlaunchApp__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
